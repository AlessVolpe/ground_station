...
/*If the user push the 'send data' button:*/
	...
	/*Save all the input*/
		...
		$query = "INSERT into rover(roverID, speed, coordsx, coordsy) VALUES ('$roverID', '$speed', '$coordsx',  '$coordsy')";
	...
	/*If the user push 'start' button*/
		...
		$query = "INSERT into rover(roverID, status) VALUES ('2', '$statusStart')";
		$result = mysqli_query($connetion, $query);
	...
	/*if the user push 'stop' button*/
		...
		$query = "INSERT into rover(roverID, status) VALUES ('2', '$statusStop')";
		$result = mysqli_query($connetion, $query);
