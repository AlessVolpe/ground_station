...
devstudyAPP.controller('HomeController',
function($scope, $http, $interval, $mdDialog,$location) {
    $scope.go = function (  ) {
      $location.path( '/surprice' );
    };
  //   $scope.ip_address = 'http://192.168.1.8';
  ...
  //    });
  //
  //   socket.on('scan_distances_data', function (data) {
  //       if (data.distance == -1) {
  //           data.distance = 400;
