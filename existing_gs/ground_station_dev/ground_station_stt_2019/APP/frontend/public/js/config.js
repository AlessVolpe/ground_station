...
devstudyAPP.directive('tchOlMap', function ($timeout) {
        ...
        return {
            ...
            link: function postLink(scope, element, attrs, ngModel) {
                ...
                // map.setCenter(new OpenLayers.LonLat(12.500875, 41.918814).transform(new OpenLayers.Projection("EPSG:4326"), new OpenLayers.Projection("EPSG:900913")), 18);
                // map.setCenter(new OpenLayers.LonLat(12.375016, 41.922363).transform(new OpenLayers.Projection("EPSG:4326"), new OpenLayers.Projection("EPSG:900913")), 18);
                ...
                scope.$watch('val', function(newValue, oldValue) {
                    if (newValue && newValue.position && newValue.position.lat && newValue.position.lon)
                        ...
                        map.addLayer(position);
                        map.setCenter(new OpenLayers.LonLat(newValue.position.lon, newValue.position.lat).transform(new OpenLayers.Projection("EPSG:4326"), new OpenLayers.Projection("EPSG:900913")), 18);
